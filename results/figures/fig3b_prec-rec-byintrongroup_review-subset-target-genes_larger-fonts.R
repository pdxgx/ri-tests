...
# larger font sizes
xaxis.text.size <- yaxis.text.size <- 13
xaxis.title.size <- yaxis.title.size <- title.text.size <- 16
legend.text.size <- 13
...
ylab.str <- paste0(paste0(rep(" ", 6), collapse = ""), "iPSC", 
                   paste0(rep(" ", 14), collapse = ""), "HX1",
                   "\n      Called RIs", collapse = "")
